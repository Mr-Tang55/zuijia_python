...
class Goods_Filters(django_filters.rest_framework.FilterSet):
    goods_category_price1 = django_filters.NumberFilter(lookup_expr='gte', label="最低价格", field_name='price')
    goods_category__price2 = django_filters.NumberFilter(lookup_expr='lte', label="最高价格", field_name='price')
    goods_sale__price1 = django_filters.NumberFilter(lookup_expr='lte', label="销售从低到高", field_name='sale')
    goods_sale__price2 = django_filters.NumberFilter(lookup_expr='lte', label="销售从高到低", field_name='sale')
